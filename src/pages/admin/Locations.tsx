...
const AdminLocationsPage = () => {
  ...
  return (
    <AdminDashboardLayout activeTab="locations">
      <div>
        <h2 className="text-2xl font-bold mb-2">Lokationer</h2>
        <p className="text-muted-foreground mb-6">Administrer forhandler lokationer</p>
